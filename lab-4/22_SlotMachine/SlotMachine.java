...
public class SlotMachine {
  public static void main(String[] args) {
    ...
    if (word_1.compareTo(word_2) == 0
      ...
      System.out.printf("Congratulations! You matched three words and won %d$", totalWon);
      ...
      System.out.printf("Congratulations! You matched two words and won %d$", totalWon);

    } else {
      totalWon = amount + total;
      System.out.printf("You didn't matched any words, you have: %d$", totalWon);
    }
    ...
    if (valid.equals("n")) {
      ...
      System.out.println("Please, enter the amount of money into the slot machine: ");
      amount = keyboard.nextInt();
      keyboard.nextLine();
